...
## Phase 2A.8 — Post-Rotation Reconciliation Status

**Date:** 2026-08-18
**Reference:** See `POST_ROTATION_RECONCILIATION.md` for full per-item evidence and readiness analysis.

> **Summary:** Leonardo reports exposed credentials have been manually changed. Devin cannot independently verify provider-side revocation or runtime validation. Items are classified as OWNER_REPORTED unless independently verified. No credential values are listed.

### Reconciliation Status Per Item

| # | Evidence Level | Current Tree | Readiness State |
|---|---|---|---|
| 1 | OWNER_REPORTED | CLEAN (removed from RAILWAY_ENV_FINAL.txt) | WAITING_MANUAL_CONFIRMATION |
| 2 | OWNER_REPORTED | CLEAN | WAITING_MANUAL_CONFIRMATION |
| 3 | OWNER_REPORTED | CLEAN | WAITING_MANUAL_CONFIRMATION |
| 4 | OWNER_REPORTED | CLEAN | WAITING_MANUAL_CONFIRMATION |
| 5 | OWNER_REPORTED | EXPOSURE (still in docs files) | WAITING_MANUAL_CONFIRMATION + CURRENT_TREE_EXPOSURE |
| 6 | OWNER_REPORTED | CLEAN | WAITING_MANUAL_CONFIRMATION |
| 7 | OWNER_REPORTED | CLEAN | WAITING_MANUAL_CONFIRMATION |
| 8 | OWNER_REPORTED | EXPOSURE (PR #1 not merged) | WAITING_MANUAL_CONFIRMATION + CURRENT_TREE_EXPOSURE |
| 9 | OWNER_REPORTED | EXPOSURE (PR #1 not merged) | WAITING_MANUAL_CONFIRMATION + CURRENT_TREE_EXPOSURE |
| 10 | OWNER_REPORTED | EXPOSURE (PR #1 not merged) | WAITING_MANUAL_CONFIRMATION + CURRENT_TREE_EXPOSURE |
| 11 | OWNER_REPORTED | EXPOSURE (PR #1 not merged) | WAITING_MANUAL_CONFIRMATION + CURRENT_TREE_EXPOSURE |
| 12 | OWNER_REPORTED | EXPOSURE (PR #1 not merged) | WAITING_MANUAL_CONFIRMATION + CURRENT_TREE_EXPOSURE |
| 13 | OWNER_REPORTED | EXPOSURE (PR #1 not merged) | WAITING_MANUAL_CONFIRMATION + CURRENT_TREE_EXPOSURE |
| 14 | OWNER_REPORTED | EXPOSURE (PR #1 not merged) | WAITING_MANUAL_CONFIRMATION + CURRENT_TREE_EXPOSURE |
| 15 | OWNER_REPORTED | EXPOSURE (PR #1 not merged) | WAITING_MANUAL_CONFIRMATION + CURRENT_TREE_EXPOSURE |
| 16 | OWNER_REPORTED | EXPOSURE (PR #1 not merged) | WAITING_MANUAL_CONFIRMATION + CURRENT_TREE_EXPOSURE |
| 17 | OWNER_REPORTED | EXPOSURE (PR #1 not merged) | WAITING_MANUAL_CONFIRMATION + CURRENT_TREE_EXPOSURE |
| 18 | OWNER_REPORTED | CLEAN (PR #1 merged) | WAITING_MANUAL_CONFIRMATION |
| 19 | NOT_APPLICABLE (ICTSI-owned) | CLEAN | WAITING_OWNER_HANDOFF |
| 20 | NOT_APPLICABLE (ICTSI-owned) | CLEAN | WAITING_OWNER_HANDOFF |
| 21 | OWNER_REPORTED | EXPOSURE (PR #5 not merged) | WAITING_MANUAL_CONFIRMATION + CURRENT_TREE_EXPOSURE |
| 22 | OWNER_REPORTED | EXPOSURE (PR #5 not merged) | WAITING_MANUAL_CONFIRMATION + CURRENT_TREE_EXPOSURE |
| 23 | OWNER_REPORTED | EXPOSURE (PR #5 not merged) | WAITING_MANUAL_CONFIRMATION + CURRENT_TREE_EXPOSURE |
| 24 | OWNER_REPORTED | EXPOSURE (PR #5 not merged) | WAITING_MANUAL_CONFIRMATION + CURRENT_TREE_EXPOSURE |
| 25 | OWNER_REPORTED | EXPOSURE (PR #5 not merged) | WAITING_MANUAL_CONFIRMATION + CURRENT_TREE_EXPOSURE |
| 26 | OWNER_REPORTED | EXPOSURE (PR #5 not merged) | WAITING_SESSION_INVALIDATION + CURRENT_TREE_EXPOSURE |
| 27 | OWNER_REPORTED | EXPOSURE (PR #5 not merged) | WAITING_MANUAL_CONFIRMATION + CURRENT_TREE_EXPOSURE |
| 28 | OWNER_REPORTED | CLEAN (PR #1 merged) | WAITING_MANUAL_CONFIRMATION |
...
| 34 | OWNER_REPORTED | CLEAN (PR #1 merged) | WAITING_MANUAL_CONFIRMATION |
...
| 37 | OWNER_REPORTED | EXPOSURE (no cleanup PR) | WAITING_MANUAL_CONFIRMATION + CURRENT_TREE_EXPOSURE |
| 38 | OWNER_REPORTED | EXPOSURE (no cleanup PR) | WAITING_MANUAL_CONFIRMATION + CURRENT_TREE_EXPOSURE |
| 39 | OWNER_REPORTED | EXPOSURE (no cleanup PR) | WAITING_MANUAL_CONFIRMATION + CURRENT_TREE_EXPOSURE |
| 40 | OWNER_REPORTED | CLEAN (PR #2 merged) | WAITING_MANUAL_CONFIRMATION |
...
|---|---|
| OWNER_REPORTED | 33 |
| NOT_APPLICABLE (PII/ICTSI-owned) | 8 |
| PROVIDER_VERIFIED | 0 |
| RUNTIME_VERIFIED | 0 |
...
|---|---|
| CLEAN | 20 |
| EXPOSURE (PR not merged) | 10 |
| EXPOSURE (PR not merged, Bot_IqOption) | 7 |
| EXPOSURE (no cleanup PR) | 3 |
| EXPOSURE (docs not cleaned) | 1 |
...
| WAITING_SESSION_INVALIDATION + CURRENT_TREE_EXPOSURE | 1 |
